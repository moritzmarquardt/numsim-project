...
if __name__ == "__main__":
    ...
    processor.plot_sample_data(all_label_data)
    all_input_data = processor.generateInputData()
    processor.plot_sample_input_data(all_input_data)
    ...
    model.plot_loss()
    model.load_model("standard_lek_model.pt")
    model.plot_test_results(1)
